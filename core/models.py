...
class Veiculo(models.Model):
    proprietario = models.ForeignKey(Pessoa, on_delete=models.SET_NULL, null=True)
...
class MovRotativo(models.Model):
    ...
    checkout = models.DateTimeField(auto_now=False, auto_now_add=False, null=True, blank=True)
    valor_hora = models.DecimalField(max_digits=5, decimal_places=2)
